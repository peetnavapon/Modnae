    ...
    <div className="loginCenter">
      <div className="loginContent">
        ...
        <div className="loginMain">
          <h1 className="headLogin">Sign In</h1>
          <form className="loginForm" onSubmit={handleSubmit}>
            ...
            <div className="inputContainer">
              ...
              <input className="loginInput" type="email" name="email" onChange={handleChange} placeholder="Email"/>
            </div>
            ...
            <p>Don’t have an account ? <Link to="/register" className="toRegister">Sign Up</Link></p>
          </form>
