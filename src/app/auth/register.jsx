                ...
                <form className="loginForm" onSubmit={handleSubmit}>
                  <div className="allName">
                    <div className="inputContainerName">
                      <svg className="inputIconUser" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                      <path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/></svg>
                      <input className="inputName" type="text" name="firstname" onChange={handleChange} placeholder="First Name" />
                    </div>
                    
                    <div className="inputContainerLast">
                      <input className="inputLast" type="text" name="lastname" onChange={handleChange} placeholder="Last Name" />
                    </div>
                  </div>


                  <div className="inputContainer">
                    <svg className="inputIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                    <path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm80 256h64c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16c0-44.2 35.8-80 80-80zm-32-96a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zm256-32H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
                    <input className="loginInput"  type="text" name="username" onChange={handleChange} placeholder="Student ID"/>
                  </div>

                  <div className="inputContainer">
                    <svg className="inputIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                  ...
                  <div className="inputContainer">
                    <svg className="inputIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    ...
                    <input className="loginInput" type="password" name="password" onChange={handleChange} placeholder="Password"/>
                  </div>
                  ...
                  <div className="inputContainer">
                    ...
                    <input className="loginInput" type="password" name="Cpassword" onChange={handleChange} placeholder="Confirm Password"/>
                  </div>

                  <p>{log}</p>
                  <button className="loginButton">Sign Up</button>
                  <p>Already have an account ? <Link to="/login" className="toRegister">Sign In</Link></p>
                </form>
            </div>
